...
<h1 class="text-3xl font-serif font-bold text-[#1B2A4A] mb-2">{{ processosStore.processoAtual.tipoAto.nome }}</h1>
...
+                <div><span class="font-bold">Tipo de Ato:</span> {{ processosStore.processoAtual.tipoAto.nome }}</div>
